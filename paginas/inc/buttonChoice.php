<?php
    ...
    echo "<div><a href=\"join.php\"><button><i class=\"fa fa-futbol-o\" aria-hidden=\"true\"></i> Jogador </button></a></div>";
    }elseif ($permission == 2) {
    echo "<div><a href=\"join.php\"><button><i class=\"fa fa-futbol-o\" aria-hidden=\"true\"></i> Equipa </button></a></div>";
    }elseif ($permission == 1) {
